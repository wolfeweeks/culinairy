import { w as u } from './index.3135a299.js';
var _;
const b = ((_ = globalThis.__sveltekit_1pru4wi) == null ? void 0 : _.base) ?? '';
var g;
const v = ((g = globalThis.__sveltekit_1pru4wi) == null ? void 0 : g.assets) ?? b,
	k = '1685055218024',
...
function x(e, t) {
	...
	const a = e instanceof SVGAElement ? e.target.baseVal : e.target,
		l = !n || !!a || m(n, t) || (e.getAttribute('rel') || '').split(/\s+/).includes('external'),
...
const L = { url: p({}), page: p({}), navigating: u(null), updated: w() };
export {
	T as I,
	f as P,
	R as S,
