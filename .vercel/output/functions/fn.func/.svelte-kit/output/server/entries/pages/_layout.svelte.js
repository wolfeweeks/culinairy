import { r as assign, t as is_function, c as create_ssr_component, h as add_attribute, a as escape, p as compute_slots, b as subscribe, f as createEventDispatcher, u as spread, w as escape_object, v as validate_component, q as missing_component, e as each } from "../../chunks/index2.js";
import { w as writable } from "../../chunks/index3.js";
import { m as modeCurrent, s as setInitialClassState } from "../../chunks/ProgressBar.svelte_svelte_type_style_lang.js";
import { C as Cookbook, U as User } from "../../chunks/Cookbook.js";
import "firebase/firestore";
import "firebase/auth";
import { s as sdk } from "../../chunks/stores.js";
...
${validate_component(Drawer, "Drawer").$$render($$result, {}, {}, {
    default: () => {
      return `${$drawerStore.id == "cookbook" ? `${validate_component(Cookbook, "Cookbook").$$render($$result, { recipes: $drawerStore.meta.recipes }, {}, {})}` : ``}`;
    }
  })}
${validate_component(FirebaseApp, "FirebaseApp").$$render($$result, { firestore: db, auth }, {}, {
    default: () => {
      return `${validate_component(AppShell, "AppShell").$$render(
        ...
        {
          header: () => {
            return `<div class="flex items-center justify-between p-4 h-full"><h3 class="h3 text-surface-900 dark:text-surface-50 text-center font-extrabold"><a data-sveltekit-preload-data="off" href="/">CULIN(AI)RY</a></h3>
				<div class="ml-auto px-2">${validate_component(User, "User").$$render($$result, {}, {}, {
              signedOut: ({ user }) => {
                return `<div slot="signedOut"><a href="login"><button class="btn-sm rounded-token md:btn bg-secondary-400 text-surface-900">Sign In
								</button></a></div>`;
              },
              default: ({ user }) => {
                return `<button type="button" class="btn-sm rounded-token md:btn bg-secondary-400 text-surface-900"><a href="/generate">Generate</a></button>
						
						<button class="btn-sm rounded-token md:btn bg-primary-400 text-surface-900"><a href="${"/" + escape(user.uid, true) + "/cookbook"}">Cookbook</a></button>

						<button class="btn-sm rounded-token md:btn bg-surface-100-800-token">Sign Out
						</button>`;
              }
            })}</div>
				${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})}</div>
		`;
          },
          default: () => {
            return `
